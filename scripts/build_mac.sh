...
cp ../index.html ~/Dropbox/DESonic/aladin
cp ../distrib/latest/aladin.js ~/Dropbox/DESonic/aladin

cd ~/Dropbox/DESonic
./cloudUploadAladin.sh
cd ~/Dropbox/aladin-lite/scripts
