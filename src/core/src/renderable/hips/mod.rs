...
pub trait HpxTileBuffer {
    ...
    fn contains(&self, texture_cell: &HEALPixCell) -> bool;

    /// Accessors
    fn get(&self, texture_cell: &HEALPixCell) -> Option<&Self::T>;
...
impl HiPS {
    ...
    #[inline]
    pub fn query_tile(&self, cell: &HEALPixCell) -> query::Tile {
        ...
        query::Tile::new(
            ...
            match self {
                D2(_) => None,
                D3(hips) => Some(hips.get_slice() as u32),
            },
        )
    }
}
